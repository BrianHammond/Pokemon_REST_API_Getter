...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.le_pokemon_name = QLineEdit(self.tab)
        self.le_pokemon_name.setObjectName(u"le_pokemon_name")
        font = QFont()
        font.setFamilies([u"MS Shell Dlg 2"])
        font.setPointSize(12)
        font.setBold(False)
        font.setItalic(False)
        self.le_pokemon_name.setFont(font)

        self.horizontalLayout_2.addWidget(self.le_pokemon_name)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.le_pokemon_name.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Enter pokemon name (press enter)", None))
